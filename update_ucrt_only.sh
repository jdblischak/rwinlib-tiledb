...
##
for f in release-windows-x86_64-mingw64_ucrt64-release-2.29-9a6284d.zip; do
...
tar xaf tiledb-windows-x86_64-mingw64_ucrt64-release-2.29-9a6284d.tar.xz
...
rm -rf ucrt64
rm -v tiledb-windows-x86_64-mingw64_ucrt64-release-2.29-9a6284.tar.xz
