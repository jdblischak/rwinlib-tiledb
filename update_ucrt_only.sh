...
##
for f in release-windows-x86_64-mingw64_ucrt64-2.30.0-9b5305d.zip; do
...
tar xaf tiledb-windows-x86_64-mingw64_ucrt64-2.30.0-9b5305d.tar.xz
...
rm -rf ucrt64
rm -v tiledb-windows-x86_64-mingw64_ucrt64-2.30.0-9b5305d.tar.xz
